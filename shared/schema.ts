...
export const insertSurveySchema = z.object({
  ...
  enableGPS: z.bool().optional().default(false),
  useTemplate: z.bool().optional().default(false),
  requirePhotos: z.bool().optional().default(false),
...
export const insertObservationSchema = z.object({
  ...
  sampleCollected: z.bool().optional().default(false),
